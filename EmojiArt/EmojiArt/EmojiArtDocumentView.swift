...
//  EmojiArt
//
//  Created by Денис Мусатов on 01.07.2020.
...
struct EmojiArtDocumentView: View {
    ...
    var body: some View {
        ...
        .alert(isPresented: self.$conformBackgroundPaste) {
            Alert(
                title: Text("Paste Background"),
                message: Text("Replace your bacground with \(UIPasteboard.general.url?.absoluteString ?? "nothing")? "),
